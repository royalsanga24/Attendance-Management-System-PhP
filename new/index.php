			...
			<center>
				...
				<div class="main-wrap">
					<header>
  						...
  						<h1 class="main-title">Attendance Management System</h1>

					</header>

					<h3 class="sub-title">Login Panel</h3>
					...
					<p class="resetpwd-wrap"><strong><a href="reset.php" style="text-decoration:none;color:#fff;font-weight:100;font-size:0.9em">Reset Password</a></strong> <span style="color:#fff;padding:0 5px;">or</span> 
					<strong><a href="signup.php" style="text-decoration:none;color:#fff;font-weight:100;font-size:0.9em">Create New Account</a></strong></p>
