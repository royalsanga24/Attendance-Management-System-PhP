  ...
  try{
    ...
    if(isset($_POST['std'])){
      ...
      //students data insertion to database table "students"
        $result = mysqli_query($aVar, "insert into students(st_id,st_name,st_dept,st_batch,st_sem,st_email) values('$_POST[st_id]','$_POST[st_name]','$_POST[st_dept]','$_POST[st_batch]','$_POST[st_sem]','$_POST[st_email]')");
