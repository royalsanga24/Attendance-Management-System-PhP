  ...
  try{
    ...
    //validation of empty fields
      if(isset($_POST['signup'])){
        ...
        $result = mysqli_query($aVar, "insert into admininfo(username,password,email,fname,phone,type) values('$_POST[uname]','$_POST[pass]','$_POST[email]','$_POST[fname]','$_POST[phone]','$_POST[type]')");
  ...
  <div class="row">
    ...
    <table class="table table-striped table-hover">
     ...
     <?php
       ...
       $all_query = mysqli_query($aVar, "SELECT * from students ORDER BY st_id asc");
