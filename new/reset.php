...
<?php
  ...
  if(isset($_POST['reset'])){
      $test = $_POST['email'];
      $row = 0;
      $query = mysqli_query($aVar, "select password from admininfo where email = '$test'");
      $row = mysqli_num_rows($query);
          if($row == 0){
?>
      
      <div  class="content"><p>Email is not associated with any account. Contact Admin.</p></div>
