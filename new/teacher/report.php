  ...
  <div class="content">
   ...
   <?php
    ...
    if(isset($_POST['sr_btn'])){
     ...
     $single = mysqli_query($aVar, "select stat_id,count(*) as countP from attendance where attendance.stat_id='$sr_id' and attendance.course = '$course' and attendance.st_status='Present'");
      $singleT= mysqli_query($aVar, "select count(*) as countT from attendance where attendance.stat_id='$sr_id' and attendance.course = '$course'");
    ...
    if(isset($_POST['sr_date'])){
     ...
     $all_query = mysqli_query($aVar, "select * from attendance where reports.stat_date='$sdate' and reports.course = '$course'");
