  ...
  <div class="form-group">
   ...
   <?php
    ...
    //  $count_tot = mysql_num_rows($all_query);
     $all_query = mysqli_query($aVar, "select stat_id,count(*) as countP from attendance where attendance.stat_id='$sr_id' and attendance.course = '$course' and attendance.st_status='Present'");
